    ...
    return (
        <>
            ...
            <div className="min-h-screen py-16 px-16 flex flex-col items-center sm:px-20">
                <h1 className="text-4xl text-center font-serif mb-10 mt-6">Supercharge your classroom. Try for <span className="text-primary cursor-pointer transition ease-in-out delay-100 hover:text-highlight">free.</span></h1>
