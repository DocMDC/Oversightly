    ...
    return (
        <div className="min-h-[900px] flex items-center justify-center">
            <div className="h-1/2 flex flex-col justify-start items-center px-5">
                ...
                <button className="text-white text-lg text-center bg-primary p-2 w-40 h-14 rounded-lg border transition ease-in-out delay-100 border-primary mb-16 hover:border hover:border-highlight hover:bg-highlight">Try for free</button>
            </div>
        </div>
    );
}
